...
* * Ключи сервера (под загрузкой понимается генерация).
* * Шаблон запроса CSR.
* * Сертификат CA.
* * Приватный ключ CA.
* * Контекст клиента.
* * Контекст сервера.
* Если на одном из шагов возникнет критическая ошибка, загрузка  
* прекратиться и вся выделенная память будет освобождена.
*/
...
* * Сертификат CA.
* * Приватный ключ CA.
* * Шаблон запроса на выдачу сертификата.
* * Контекст клиента.
* * Контекст сервера.
*/
...
/*!
* @details
* Под сервером и клиентом понимаются части данного класса: серверная в локальной сети и клиентская во внешней сети.
*/
