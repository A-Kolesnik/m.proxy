...
/*!
* @details
* ƒл€ выполнени€ одной из операций установлени€ соединени€ используетс€ API OpenSSL [SSL_connect](https://www.openssl.org/docs/man3.0/man3/SSL_connect.html).
*/
...
/*!
* @details
*  онфигураци€ состоит из установки работы SSL в режиме клиента и св€зывание SSL с BIO.  
