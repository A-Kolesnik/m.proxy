// Описывает: 
// 1. Функция инициализации части модуля, выполняющей операции
//    TLS-соединения.
// 2. Функция сброса состояния данной части модуля (освобождение памяти)
// 3. Сущность Proxy, выступающая в роли сервера в локальной сети и в роли
//	  клиента в глобальной компьютерной сети.
